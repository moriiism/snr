...
void ArgValExpand::Init(int argc, char* argv[])
{
    progname_ = "expand";
...
void ArgValExpand::Print(FILE* fp) const
{
...
void ArgValExpand::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValExpand::Usage(FILE* fp) const
{
    fprintf(fp,
