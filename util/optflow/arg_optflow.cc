...
void ArgValOptflow::Init(int argc, char* argv[])
{
    progname_ = "optflow";
...
void ArgValOptflow::Print(FILE* fp) const
{
...
void ArgValOptflow::SetOption(int argc, char* argv[], option* long_options)
{
    if(0 < g_flag_verbose){
        MPrintInfo("start...");
    }
...
void ArgValOptflow::Usage(FILE* fp) const
{
    fprintf(fp,
